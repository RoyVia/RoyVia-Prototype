...
//        barcodeScannerViewController.onCodeScanned = onCodeScanned
//        barcodeScannerViewController.isScanning = isScanning
...
//                        print("Capture session started on background thread.")
//                    }
//                }
//            } else {
//                DispatchQueue.global(qos: .userInitiated).async {
//                    if session.isRunning {
//                        session.stopRunning()
//                        print("Capture session stopped on background thread.")
//                    }
//                }
//            }
//        }
...
//            print("Initial startRunning called from background thread.")
//        }
//    }
//    
//    private func setupOverlay() {
//        // Overlay setup remains unchanged.
//        let overlayView = UIView(frame: view.bounds)
//        overlayView.backgroundColor = UIColor.black.withAlphaComponent(0.5)
//        overlayView.isUserInteractionEnabled = false
//        
//        let viewfinderWidth: CGFloat = view.bounds.width * 0.7
//        let viewfinderHeight: CGFloat = view.bounds.height * 0.3
//        let viewfinderRect = CGRect(
//            x: view.bounds.midX - viewfinderWidth / 2,
//            y: view.bounds.midY - viewfinderHeight / 2,
...
//        instructionLabel.text = "Align the barcode inside the frame to scan."
...
//            print("Barcode scanned and capture session stopped.")
//        }
//        
//        DispatchQueue.main.async {
//            self.onCodeScanned?(stringValue, codeType)
//        }
//    }
//    
